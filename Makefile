...
remscp: remscp.o serial.o ic7300.o flslider2.o progdefaults.o waterfall.o
	$(CC) -o remscp remscp.o serial.o ic7300.o flslider2.o progdefaults.o waterfall.o $(LIBS)
